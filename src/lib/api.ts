...
export const cardApi = {
  getBalance: (cardId: string) => 
    apiRequest(`/api/cards?id=${cardId}`),
...
export const topUpApi = {
  getTopUps: (cardId: string) => 
    apiRequest(`/api/topups?id=${cardId}`),
...
export const pumpHistoryApi = {
  getHistory: (cardId: string) => 
    apiRequest(`/api/pump-history?id=${cardId}`),

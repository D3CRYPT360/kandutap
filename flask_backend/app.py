...
class CardList(Resource):
    ...
    def get(self):
        try:
            ...
            if card_id:
                # First check if the card ID format is valid
...
class PumpHistoryList(Resource):
    ...
    def post(self):
        try:
            ...
            # Add pump history with current local time
            current_time = get_current_time()
            cursor.execute(
